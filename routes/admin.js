...
const categoryStorage = multer.diskStorage({
    destination: (req, file, cb) => {
        ...
        const folderPath = path.join(__dirname, "public", "Categories");
...
const itemStorage = multer.diskStorage({
    destination: (req, file, cb) => {
        ...
        const folderPath = path.join(__dirname, "public", "Items");
...
router.put('/approve/order/:orderid', fetchUser, [
    ...
    try {
        ...
        if (orderToApprove.orderStatus === "Approval Remaining") {
            ...
            const approvedOrder = await Orders.findByIdAndUpdate(req.params.orderid, { $set: { orderStatus: "Approved", orderApproveDate: approveDate.toISOString(), orderApprovedBy: "Admin", orderApproverName: userData.name, orderArrivalTime: req.body.arrivalTime } }, { new: true });
